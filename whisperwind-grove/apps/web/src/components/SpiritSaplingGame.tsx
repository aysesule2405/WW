...
const growthStages = [
  '/assets/backgrounds/sapling-growth/sapling-1.png',
  '/assets/backgrounds/sapling-growth/sapling-2.png',
  '/assets/backgrounds/sapling-growth/sapling-3.png',
  '/assets/backgrounds/sapling-growth/sapling-4.png',
  '/assets/backgrounds/sapling-growth/sapling-5.png',
];
...
type SaplingAction = Exclude<SaplingEffect, null>;
...
export default function SpiritSaplingGame({ onExit }: Props) {
  ...
  const canUseNurtureAction = !isTalking && !isRecharging && !atFinalStage;
  ...
  if (atFinalStage && previousStageIndex === null) {
    return (
      <div style={styles.page}>
        <div style={styles.topBar}>
          <button style={styles.backButton} onClick={onExit}>
        ...
        <div style={styles.celebrationWrap}>
          <div style={styles.celebrationCard}>
            <p style={styles.celebrationOverline}>Sacred Bloom Achieved</p>
            <h3 style={styles.celebrationTitle}>Your Sapling Has Blossomed</h3>
            <p style={styles.celebrationSubtitle}>
              Guided by {selectedGuardian.name}, this spirit now stands strong and radiant.
            </p>

            <div style={styles.celebrationVisualArea}>
              <img
                key={`celebration-${transitionKey}`}
                src={growthStages[growthStages.length - 1]}
                alt="Fully grown spirit sapling"
                style={styles.celebrationSapling}
              />
              <img src={selectedGuardian.image} alt={selectedGuardian.name} style={styles.celebrationGuardian} />
            </div>

            <div style={styles.celebrationActions}>
              <button type="button" style={styles.celebrationPrimaryAction} onClick={restartJourney}>
                Grow Another Sapling
              </button>
              <button
                type="button"
      ...
      <div style={styles.gameLayout}>
        <div style={styles.saplingPanel}>
          ...
          <p style={styles.statusText}>
            {atFinalStage
              ? 'Your spirit sapling is now fully grown.'
