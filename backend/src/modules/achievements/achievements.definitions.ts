...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  {
    code: 'sapling_first_harvest',
    title: 'The Tree Gives Back',
    description: 'Complete your first Gentle Harvest and gather six ripe fruits.',
    icon: '🧺', rarity: 'common', category: 'sapling',
    criteria: { gameSlug: 'spirit-sapling', fruitsCollectedGte: 6 },
  },
  {
    code: 'sapling_patient_harvest',
    title: 'Gentle Hands',
    description: 'Complete a Gentle Harvest without tugging a single unripe fruit.',
    icon: '🍎', rarity: 'rare', category: 'sapling',
    criteria: { gameSlug: 'spirit-sapling', hastyAttempts: 0, fruitsCollectedGte: 6 },
  },
  {
    code: 'sapling_need_listener',
    title: 'Fluent in Leaves',
    description: 'Answer the sapling’s changing need correctly at least four times in one journey.',
    icon: '🍃', rarity: 'rare', category: 'sapling',
    criteria: { gameSlug: 'spirit-sapling', needMatchCountGte: 4 },
  },
  {
    code: 'sapling_event_keeper',
    title: 'Keeper Through the Storm',
    description: 'Protect the sapling through two forest events in one journey.',
    icon: '⛈️', rarity: 'epic', category: 'sapling',
    criteria: { gameSlug: 'spirit-sapling', eventsSurvivedGte: 2 },
  },
  {
    code: 'sapling_uncorrupted',
    title: 'A Clear-Hearted Grove',
    description: 'Reach the harvest without allowing corruption to take hold.',
    icon: '💚', rarity: 'epic', category: 'sapling',
    criteria: { gameSlug: 'spirit-sapling', corruptionScore: 0 },
  },
  {
  ...
  {
    code: 'delivery_map_meadow',
    title: 'Village Runner',
    description: 'Complete a delivery run through Wind Village.',
    icon: '🏘️', rarity: 'common', category: 'delivery',
    criteria: { gameSlug: 'delivery-on-the-wind', mapId: 'meadow' },
  },
  {
  ...
  {
    code: 'delivery_map_coastal',
    title: 'Saltwind Courier',
    description: 'Complete the sunlit Coastal Run.',
    icon: '🌊', rarity: 'common', category: 'delivery',
    criteria: { gameSlug: 'delivery-on-the-wind', mapId: 'coastal' },
  },
  {
    code: 'delivery_map_mountain',
    title: 'Mountain Messenger',
    description: 'Carry every package safely through Mountain Pass.',
    icon: '⛰️', rarity: 'rare', category: 'delivery',
    criteria: { gameSlug: 'delivery-on-the-wind', mapId: 'mountain' },
  },
  {
  ...
  {
    code: 'half_moon_ritual_complete',
    title: 'The Moon Answers',
    description: 'Complete all three levels and finish the lunar ritual.',
    icon: '🌝', rarity: 'rare', category: 'halfmoon',
    criteria: { gameSlug: 'half-moon', completed: true, won: true },
  },
  {
    code: 'half_moon_hard_victory',
    title: 'Against the Dark Tide',
    description: 'Complete the full ritual against the Half Moon on Hard difficulty.',
    icon: '🌑', rarity: 'legendary', category: 'halfmoon',
    criteria: { gameSlug: 'half-moon', completed: true, won: true, difficulty: 'hard' },
  },
  {
